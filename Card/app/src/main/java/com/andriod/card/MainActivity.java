...
public class MainActivity extends AppCompatActivity implements TimerUtils.TimerListener{
    //定义一个属性变量，，，类型就是绑定类的类型
...
//            mBinlding.countDown.setText("2");
            ...
            timerUtils =new TimerUtils(3,TimerUtils.Order.DESCENDING,this);
            timerUtils.start();
        });
...
//            实现界面跳转 ：应用内   应用外部跳转action隐式跳转
            Intent intent = new Intent(this,GameActivity.class);//字节码 反射注解实现
